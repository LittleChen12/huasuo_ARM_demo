...
namespace RobotLibrary
{
    ...
    {//做继承20240516
        ...
        ****************************************************************************/
        public static double[,] ZXToRotMatrix(Vector3 z, Vector3 x)
        {
            // 确保 z 是单位向量
        ...
        *@return  double[3,3] : 旋转矩阵
        ****************************************************************************/
        public static double[,] ZThetaToRotMatrix(Vector3 z, float theta)
        {
            // 确保 z 是单位向量
            z = Vector3.Normalize(z);
        ...
        ****************************************************************************/
        ...
        public static Vector3 ZThetaToX(Vector3 z, float theta)
        {
            // 确保 z 是单位向量
            z = Vector3.Normalize(z);
      ...
      *@return   double[3] : 3D欧拉角 Rx, Ry, Rz;
      ****************************************************************************/
        public static double[] RotMatrixToRxyz(Matrix4x4 R)
        {
            double Rx, Ry, Rz;
        ...
        ****************************************************************************/
        static public double[] RadToAngle(double[] joints)
        {
        ...
        ****************************************************************************/
        static public double[] AngleToRad(double[] joints)
        {
        ...
        ****************************************************************************/
        ...
        public static void InitialOrientInpParam(double[,] Rs, double[,] Re, OrientInpParam Param)
        {
