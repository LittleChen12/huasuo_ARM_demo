...
namespace xCoreSDK_CSharp
{
    public class xMateRobotDemo
    {
        ...
        public void Example_Move1()
        {
            ...
            absj1.jointTarget.joints = new List<double> { 30/180*Math.PI,3.64/180*Math.PI, -90/180*Math.PI, -5.64/180*Math.PI, -88.83/180*Math.PI, 41.97/180*Math.PI };
        ...
        public void my_move()
        {
            ...
            MoveCommand absj1 = new MoveCommand(),absj2=new MoveCommand();
            absj1.jointTarget.joints = new List<double> { -15 / 180 * Math.PI, 3.64 / 180 * Math.PI, -90 / 180 * Math.PI, -5.64 / 180 * Math.PI, -88.83 / 180 * Math.PI, 41.97 / 180 * Math.PI };
            absj2.jointTarget.joints = new List<double> { -15.119 / 180 * Math.PI, 31.176 / 180 * Math.PI, -102.573 / 180 * Math.PI, -5.995 / 180 * Math.PI, 0.929 / 180 * Math.PI, 29.78 / 180 * Math.PI };


            absj1.speed = 200;
            absj2.speed = 500;
            robot.executeCommand(MoveCommand.Type.MoveAbsJ, new List<MoveCommand> { absj2}, out ec);
